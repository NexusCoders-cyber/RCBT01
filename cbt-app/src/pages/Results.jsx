    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
      ...
      >
        ...
        <motion.div
          initial={{ scale: 0.9 }}
          animate={{ scale: 1 }}
          className={`card p-8 text-center bg-gradient-to-br ${getScoreBg(overallScore)} text-white`}
        >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="card p-4 text-center">
            <div className="w-10 h-10 rounded-lg bg-green-100 dark:bg-green-900/50 flex items-center justify-center mx-auto mb-2">
          ...
          <div className="card p-4 text-center">
            <div className="w-10 h-10 rounded-lg bg-red-100 dark:bg-red-900/50 flex items-center justify-center mx-auto mb-2">
          ...
          <div className="card p-4 text-center">
            <div className="w-10 h-10 rounded-lg bg-slate-100 dark:bg-slate-700 flex items-center justify-center mx-auto mb-2">
              <MinusCircle className="w-5 h-5 text-slate-600 dark:text-slate-400" />
            </div>
            <p className="text-2xl font-bold text-slate-600 dark:text-slate-400">{totalUnanswered}</p>
          ...
          <div className="card p-4 text-center">
            ...
            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{formatDuration(duration)}</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="card p-6">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Score Distribution</h3>
          ...
          {Object.keys(subjectResults || {}).length > 1 && (
            <div className="card p-6">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Subject Performance</h3>
              <ResponsiveContainer width="100%" height={200}>
        ...
        {Object.keys(subjectResults || {}).length > 0 && (
          <div className="card p-6">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Subject Breakdown</h3>
            <div className="space-y-4">
              {Object.entries(subjectResults).map(([id, data]) => (
                <div key={id} className="p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50">
