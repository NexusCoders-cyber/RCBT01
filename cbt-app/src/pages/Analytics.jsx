      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400">Track your progress over time</p>
          </div>
        </div>
      ...
      >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div className="card p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-slate-900 dark:text-white">{stats.totalTime}m</p>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <div className="card p-6">
            <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Score Progress</h3>
          ...
          {modeDistribution.length > 0 && (
            <div className="card p-6">
              <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Session Distribution</h3>
              <ResponsiveContainer width="100%" height={250}>
                <PieChart>
                  <Pie
        ...
        <div className="card p-6">
          <h3 className="font-semibold text-slate-900 dark:text-white mb-4">Recent Sessions</h3>
          <div className="space-y-3 max-h-96 overflow-y-auto">
            {allHistory.slice().reverse().slice(0, 10).map((session) => (
              <div key={session.id} className="p-4 rounded-xl bg-slate-50 dark:bg-slate-700/50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                    session.mode === 'full' 
                      ? 'bg-green-100 dark:bg-green-900/50' 
